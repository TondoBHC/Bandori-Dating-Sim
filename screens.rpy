...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Start") action Play("sound", "music/gameStart.mp3", selected = None), Start()
...
screen main_menu():
    tag menu
    if persistent.bond == 'Kaoru':
        $ mm_bg= 'gui/main_v1.png'
    elif persistent.bond == 'Tomoe':
        $ mm_bg= 'gui/main_v2.png'
    elif persistent.bond == 'Hina':
        $ mm_bg= 'gui/main_v3.png'
    else:
        $ mm_bg= renpy.random.choice(['gui/main_v1.png', 'gui/main_v2.png', 'gui/main_v3.png'])
    add mm_bg
    $ x=114
    imagebutton auto "gui/main_start_%s.png" xpos 773 ypos x focus_mask True action Start()
    $ x+=71
    imagebutton auto "gui/main_load_%s.png" xpos 773 ypos x focus_mask True  action ShowMenu('load')
    $ x+=71
